...
# 定义文件路径
json_file_path = '/home1/hxl/disk/EAGLE/qbs/Eagle_LanguageBind/dataset/Video/added/processed/combined/combined_acnetcap2qa.json'
output_txt_path = 'missing_videos_opencv.txt'
output_json_path = '/home1/hxl/disk/EAGLE/qbs/Eagle_LanguageBind/dataset/Video/added/processed/combined/combined-opencv-pass-5.json'
...
def process_item(item):
    try:
        ...
        video_path = os.path.join('/home1/hxl/disk/EAGLE/qbs/Eagle_LanguageBind/dataset/Video/added/processed/combined', video_path)
