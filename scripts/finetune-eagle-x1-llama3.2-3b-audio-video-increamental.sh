#!/bin/bash
NAME=Incremental/Audio/finetune-video-llama3.2-3b/finetune/pr_llm/finetune-audio-llama3.2-3b
...
CUDA_VISIBLE_DEVICES='4' python -m torch.distributed.run \
    --nproc_per_node 1 --master_port 25044 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Incremental/Audio/finetune-video-llama3.2-3b/pretrain/pretrain-audio-llama3.2-3b/mm_projector.bin \
