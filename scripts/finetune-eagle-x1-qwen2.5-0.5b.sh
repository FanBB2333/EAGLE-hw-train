#!/bin/bash
NAME=Baseline/Images/finetune/en_pr/finetune-eagle-x1-qwen2.5-0.5b-image
...
CUDA_VISIBLE_DEVICES='2' python -m torch.distributed.run \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Baseline/Images/pretrain/pretrain-eagle-x1-qwen2.5-0.5b_image_L/mm_projector.bin \
