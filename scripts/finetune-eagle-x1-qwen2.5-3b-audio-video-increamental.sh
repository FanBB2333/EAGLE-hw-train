#!/bin/bash
NAME=Incremental/Audio/finetune-video-qwen2.5-3b/finetune/en_pr/finetune-audio-qwen2.5-3b
...
CUDA_VISIBLE_DEVICES='1' python -m torch.distributed.run \
    --nproc_per_node 1 --master_port 25041 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Incremental/Audio/finetune-video-qwen2.5-3b/pretrain/pretrain-audio-qwen2.5-3b/mm_projector.bin \
