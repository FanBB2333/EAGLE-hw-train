#!/bin/bash
NAME=Baseline/Audio/finetune/pr_llm/finetune-audio-qwen2.5-1.5b
...
CUDA_VISIBLE_DEVICES='2' python -m torch.distributed.run \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Baseline/Audio/pretrain/pretrain-audio-qwen2.5-1.5b/mm_projector.bin \
