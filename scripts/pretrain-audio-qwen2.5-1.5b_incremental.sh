#!/bin/bash
NAME=Incremental/Audio/finetune-eagle-x1-qwen2.5-1.5b-image_L/pretrain/pretrain-audio-qwen2.5-1.5b
...
CUDA_DEVICE_ORDER=PCI_BUS_ID CUDA_VISIBLE_DEVICES='1,2' python -m torch.distributed.run \
