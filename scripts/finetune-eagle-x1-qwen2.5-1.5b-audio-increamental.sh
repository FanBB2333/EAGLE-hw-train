#!/bin/bash
NAME=Incremental/Audio/finetune-eagle-x1-qwen2.5-1.5b-image_L/finetune/en_pr/finetune-audio-qwen2.5-1.5b
...
CUDA_VISIBLE_DEVICES='3' python -m torch.distributed.run \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Incremental/Audio/finetune-eagle-x1-qwen2.5-1.5b-image_L/pretrain/pretrain-audio-qwen2.5-1.5b/mm_projector.bin \
