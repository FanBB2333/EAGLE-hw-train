...
# run eval image
python eval_image_all.py --model_path ./checkpoints/disk2/Images/finetune/pr_llm/finetune-image-llama3.2-3b-fzy-qwen2vl-batch-llava-eagle-ocrb-nemotron-8b-en-pr --gpus 0 --datasets ocrbenchv2
python eval_image_all.py --model_path ./checkpoints/disk2/Images/finetune/pr_llm/finetune-image-llama3.2-3b-fzy-qwen2vl-batch-llava-eagle-ocrb-nemotron-8b-en    --gpus 0 --datasets ocrbenchv2
