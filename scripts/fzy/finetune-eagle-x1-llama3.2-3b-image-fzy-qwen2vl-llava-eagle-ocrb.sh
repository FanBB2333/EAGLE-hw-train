...
NAME=disk2/Images/finetune/pr_llm/finetune-image-llama3.2-3b-fzy-qwen2vl-batch-llava-eagle-ocrb-Qwen2.5_VL_7B-en
...
CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.run \
    ...
    --version llama3 \
    --data_path ./eval_image/labeled_data/Qwen2.5_VL_7B_Instruct_0826/labeled_ocrbench_v2.json \
    --image_folder ./eval_image/labeled_data/Qwen2.5_VL_7B_Instruct_0826 \
