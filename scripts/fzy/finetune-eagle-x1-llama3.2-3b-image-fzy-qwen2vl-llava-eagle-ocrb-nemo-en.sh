...
CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.run \
    ...
    --version llama3 \
    --data_path ./eval_image/labeled_data/Llama_3.1_Nemotron_Nano_VL_8B_V1_0828/labeled_ocrbench_v2.json \
    --image_folder ./eval_image/labeled_data/Llama_3.1_Nemotron_Nano_VL_8B_V1_0828 \
