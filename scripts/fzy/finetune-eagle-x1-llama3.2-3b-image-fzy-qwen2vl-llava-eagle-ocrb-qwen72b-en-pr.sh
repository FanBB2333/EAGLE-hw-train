...
NAME=disk2/Images/finetune/pr_llm/finetune-image-llama3.2-3b-fzy-qwen2vl-batch-llava-eagle-ocrb-qwen2.5_VL-72b-en-pr
...
cp -r  train_image_fzy_inc_ocrb.py ./checkpoints/$NAME
...
CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.run \
    --nproc_per_node 1 --master_port 25010 \
    train_image_fzy_inc_ocrb.py \
    --model_name_or_path ./model/LLM/Llama-3.2-3B-Instruct \
    --version llama3 \
    --data_path ./eval_image/labeled_data/Qwen2.5_VL_72B_Instruct_AWQ_0828/labeled_ocrbench_v2.json \
    --image_folder ./eval_image/labeled_data/Qwen2.5_VL_72B_Instruct_AWQ_0828 \
    --vision_tower ./model/disk2/Qwen/Qwen2-VL-2B-Instruct  \
    --pretrain_mm_mlp_adapter ./checkpoints/disk2/Images/pretrain/pretrain-eagle-x1-llama3.2-3b_image_L_fzy-llava-qwen2vl-batch/mm_projector.bin \
