#!/bin/bash
NAME=disk2/Video/pretrain/pretrain-video-llama3.2-3b-fzy-qwen2vl-eagle
...
# /home1/hxl/disk/EAGLE/qbs/Eagle_LanguageBind/
    # --data_path ./dataset/Video/added/processed/combined/combined-opencv-pass-4.json \
...
CUDA_VISIBLE_DEVICES='1,2,3,4' python -m torch.distributed.run \
    --nproc_per_node 4 --master_port 25099 \
    train_video1.py \
