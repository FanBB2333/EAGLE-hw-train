#!/bin/bash
NAME=Baseline/Video/finetune/pr_llm/finetune-video-qwen2.5-1.5b
...
CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.run \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Baseline/Video/pretrain/pretrain-video-qwen2.5-1.5b/mm_projector.bin \
