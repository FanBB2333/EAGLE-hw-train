#!/bin/bash
NAME=Incremental/Audio/finetune-eagle-x1-llama3.2-3b-image_L/finetune/pr_llm/finetune-audio-llama3.2-3b
...
CUDA_VISIBLE_DEVICES='3' python -m torch.distributed.run \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Incremental/Audio/finetune-eagle-x1-llama3.2-3b-image_L/pretrain/pretrain-video-llama3.2-3b/mm_projector.bin \
