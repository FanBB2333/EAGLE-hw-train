#!/bin/bash
NAME=Baseline/Images/pretrain/pretrain-eagle-x1-llama3.1-8b_image_L
...
CUDA_VISIBLE_DEVICES='3,4' python -m torch.distributed.run \
    --nproc_per_node 2 --master_port 25032 \
    train_image.py \
    --model_name_or_path ./model/LLM/Meta-Llama-3.1-8B-Instruct \
    --version plain \
