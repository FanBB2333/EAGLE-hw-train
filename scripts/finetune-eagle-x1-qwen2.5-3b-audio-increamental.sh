#!/bin/bash
NAME=Incremental/Audio/finetune-eagle-x1-qwen2.5-3b-image_L/finetune/pr/finetune-audio-qwen2.5-3b
...
cp -r  train_audio_load_image.py ./checkpoints/$NAME
...
CUDA_VISIBLE_DEVICES='0' python -m torch.distributed.run \
    --nproc_per_node 1 --master_port 25038 \
    train_audio_load_image.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Incremental/Audio/finetune-eagle-x1-qwen2.5-3b-image_L/pretrain/pretrain-audio-qwen2.5-3b/mm_projector.bin \
