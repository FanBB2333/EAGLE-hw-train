#!/bin/bash
NAME=Baseline/Images/finetune/en_pr/finetune-eagle-x1-qwen2.5-7b-image
...
CUDA_VISIBLE_DEVICES='1' python -m torch.distributed.run \
    --nproc_per_node 1 --master_port 25040 \
    train_image.py \
    --model_name_or_path ./model/LLM/Qwen2.5-7B-Instruct \
    --version qwen_2 \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Baseline/Images/pretrain/pretrain-eagle-x1-qwen2.5-7b_image_L/mm_projector.bin \
