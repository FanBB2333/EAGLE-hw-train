#!/bin/bash
NAME=Baseline/Audio/finetune/pr/finetune-audio-qwen2.5-3b
...
CUDA_VISIBLE_DEVICES='1' python -m torch.distributed.run \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Baseline/Audio/pretrain/pretrain-audio-qwen2.5-3b/mm_projector.bin \
