#!/bin/bash
NAME=Baseline/Images/finetune/pr/finetune-eagle-x1-qwen2.5-3b-image_L
...
CUDA_VISIBLE_DEVICES='3' python -m torch.distributed.run \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Baseline/Images/pretrain/pretrain-eagle-x1-qwen2.5-3b_image_L/mm_projector.bin \
