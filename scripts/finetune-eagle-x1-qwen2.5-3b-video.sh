#!/bin/bash
NAME=Baseline/Video/finetune/pr_llm/finetune-video-qwen2.5-3b
...
CUDA_VISIBLE_DEVICES='1' python -m torch.distributed.run \
    --nproc_per_node 1 --master_port 25039 \
    train_video1.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/Baseline/Video/pretrain/pretrain-video-qwen2.5-3b/mm_projector.bin \
