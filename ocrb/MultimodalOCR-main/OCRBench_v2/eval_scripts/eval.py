...
def process_predictions(input_path, output_path):
    ...
    # for task_name in ["table parsing en","document parsing en","formula recognition en"]:
    for task_name in ["cognition VQA en", "diagram QA en", "document classification en"]:
        print("\n" + task_name)
